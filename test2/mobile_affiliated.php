	...
	<body>
		...
		<div id="navigationBar" class="navBar">
			<ul class="navBarList">
				...
				<a class="navLink" href="mobileUpload.php"><li class="navBarItem">Share</li></a>
				<a class="navLink" href="mobile_login.php"><li class="navBarItem">Login</li></a>
				<a class="navLink" href="mobile_aboutus.php"><li class="navBarItem">About Us</li></a>
				<a class="navLink" href="mobile_affiliate.php"><li class="navBarItem">Affiliates</li></a>
			</ul>
		</div>
		<div id="navigationBarAlt">
			<ul class="navBarListAlt">
				...
				<a class="navLink" href="mobileUpload.php"><li class="navBarItemAlt">Share</li></a>
				<a class="navLink" href="mobile_login.php"><li class="navBarItemAlt">Login</li></a>
